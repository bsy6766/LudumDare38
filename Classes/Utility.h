...
namespace Utility
{
	inline int getZOrder(const float f)
	{
		return 100000 - (50000 + static_cast<int>(f));
	}

	inline int getMaxZOrder()
	{
		return 100000;
	}

	inline int getDebugZOrder()
	{
		return 500000;
	}
	...
	namespace Math
	{
		...
		static inline float fastFloor(float value)
		{
